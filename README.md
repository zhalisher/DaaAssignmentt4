<img width="453" height="288" alt="изображение" src="https://github.com/user-attachments/assets/2d6d9cc4-c9d7-4b52-aff7-741b7517ca63" /><img width="453" height="457" alt="изображение" src="https://github.com/user-attachments/assets/9addd5ba-e65d-473c-8105-87c606118e3f" /><img width="321" height="457" alt="изображение" src="https://github.com/user-attachments/assets/bcdbcb86-909d-48b9-8d55-d4f0baf4c750" />This project implements and analyzes graph algorithms for smart city task scheduling, focusing on Strongly Connected Components (SCC), topological ordering, and shortest/longest paths in Directed Acyclic Graphs (DAGs). The system processes task dependency graphs ranging from 6 to 50 nodes, demonstrating efficient performance across various graph structures while providing optimal scheduling solutions.
